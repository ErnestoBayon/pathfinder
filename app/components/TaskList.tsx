    ...
    <div className="flex flex-col p-6">
      ...
      <form onSubmit={add} className="flex items-center gap-2.5">
        ...
        <button
          ...
          className="rounded-full bg-cta px-6 py-3 text-sm font-semibold text-[#0A0A0A] transition-colors duration-200 ease-out hover:bg-cta-hover disabled:opacity-40 disabled:hover:bg-cta"
        >
          {adding ? "…" : "Add"}
        </button>
      </form>
